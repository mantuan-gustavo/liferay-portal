    ...
    function wrapperSimpleField(PORTLET_NAME, key, { label, options, suffix, prefix, inlineField,
     ...
     function helpMessageDivContent(helpMessage) {
      ...
      document.getElementById("form-button-submit").onclick = function () {
        let configurationActionUrlEditConfigurationMode = `=com_liferay_portlet_configuration_web_portlet_PortletConfigurationPortlet&p_p_lifecycle=1&p_p_state=pop_up&p_p_mode=view&_com_liferay_portlet_configuration_web_portlet_PortletConfigurationPortlet_javax.portlet.action=editConfiguration&_com_liferay_portlet_configuration_web_portlet_PortletConfigurationPortlet_mvcPath=/edit_configuration.jsp&_com_liferay_portlet_configuration_web_portlet_PortletConfigurationPortlet_returnToFullPageURL=/&_com_liferay_portlet_configuration_web_portlet_PortletConfigurationPortlet_portletConfiguration=true&_com_liferay_portlet_configuration_web_portlet_PortletConfigurationPortlet_portletResource=${INSTANCE}&_com_liferay_portlet_configuration_web_portlet_PortletConfigurationPortlet_previewWidth=&_com_liferay_portlet_configuration_web_portlet_PortletConfigurationPortlet_settingsScope=portletInstance&p_auth=${Liferay.authToken}`;
        document.getElementById(`${PORTLET_NAME}fm`).action = BASE_URL_CONFIGURATION + configurationActionUrlEditConfigurationMode;
